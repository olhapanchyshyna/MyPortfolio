function sliders(){
    ...
    function touchSlider(slidesItem, sliderWrapperSelector, slidesFiledSelector, sliderSelector, dotSelector) {
        const slides = document.querySelectorAll(slidesItem);
        const sliderWrapper = document.querySelector(sliderWrapperSelector);
        const slidesFiled = document.querySelector(slidesFiledSelector);
        const slider = document.querySelector(sliderSelector);
    ...
    touchSlider('.use__item', '.use__wrapper', '.use__list', '.use', '.use .dot');
    touchSlider('.portfolio__item', '.portfolio__wrapper', '.portfolio__list', '.portfolio', '.portfolio .dot');
